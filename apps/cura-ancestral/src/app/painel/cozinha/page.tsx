  ...
  return (
    <main className="min-h-screen bg-crema pb-20">
      ...
      <div className="max-w-4xl mx-auto px-4 py-8 md:py-12">
        <div className="bg-white p-8 rounded-2xl shadow-xl border-l-8 border-amber-cta">
            ...
            <div className="flex-1 space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-8">
                <div className="p-6 bg-gray-50 rounded-2xl border-2 border-dashed border-gray-200 text-center">
                  ...
                  <p className="text-xs text-gray-500 mb-4">Segurança entre remédios e ervas.</p>
                  <a 
                    href="/imagem/pdf/escudo-interacoes.pdf" 
                    download 
                    className="bg-amber-cta text-white font-black py-3 px-6 rounded-xl shadow-md hover:scale-105 transition-transform inline-flex items-center gap-2 text-sm uppercase"
                  >
                ...
                <div className="p-6 bg-gray-50 rounded-2xl border-2 border-dashed border-gray-200 text-center">
                  ...
                  <p className="text-xs text-gray-500 mb-4">Guia rápido para sua geladeira.</p>
                  <a 
                    href="/imagem/pdf/mapa-consulta-rapida.pdf" 
                    download 
                    className="bg-forest text-white font-black py-3 px-6 rounded-xl shadow-md hover:scale-105 transition-transform inline-flex items-center gap-2 text-sm uppercase"
                  >
