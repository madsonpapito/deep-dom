      ...
      <div className="max-w-4xl mx-auto px-4 py-8 md:py-12">
        <div className="bg-white p-8 rounded-2xl shadow-xl border-t-8 border-gold">
          <div className="flex flex-col md:flex-row gap-8 items-center md:items-start">
            <div className="relative w-full max-w-[300px] shadow-2xl rounded-2xl overflow-hidden">
               <Image src="/imagem/cofre-das-ervas-raras.webp" alt="Cofre das Ervas Raras" width={400} height={400} className="w-full h-auto" />
            </div>
