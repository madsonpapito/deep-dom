      ...
      <div className="w-full max-w-3xl px-4 py-8 md:py-12 text-center">
        ...
        <section className="bg-white p-8 md:p-12 rounded-2xl shadow-xl border-t-8 border-forest relative">
          ...
          <p className="text-lg md:text-xl text-gray-700 leading-relaxed mb-8 font-medium italic">
            No entanto, a maioria dos nossos alunos sêniores carrega uma &quot;bagagem&quot; pesada: <strong>anos de inflamação profunda</strong> que as ervas comuns levam tempo para alcançar.
          </p>

          <div className="bg-sage/10 p-6 rounded-xl border-l-4 border-forest text-left mb-8">
            <p className="text-forest font-bold text-lg leading-snug">
              Apresento o &quot;Cofre das Ervas Raras&quot; — O protocolo de regeneração avançada para quem não tem tempo a perder.
            </p>
          </div>
